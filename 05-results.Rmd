...
From the cleveland dot plot, we see that WWI and WWII are greater in scale than any other war which is not surprising. The natural move now is to analyze the effect of those two wars on different indicators such as gdp and education. 
...
Germany, China and Russia are the three countries with the most number of total deaths in all inter-state wars(ranked in that same order). South American Countries, Canada and Australia are among the countries with the least number of total battle deaths. 
