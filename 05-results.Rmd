...
```{r fig.width=5}
# import data
inter_state <- read.csv('docs/data/raw/Inter-StateWarData_v4.0.csv')
intra_state <- read.csv('docs/data/raw/Intra-StateWarData_v4.1.csv')
extra_state <- read.csv('docs/data/raw/Extra-StateWarData_v4.0.csv')
non_state <- read.csv('docs/data/raw/Non-StateWarData_v4.0.csv')
...
```{r}
country_codes <- read.csv('docs/data/raw/COW country codes.csv')
# Intra-state:
...
write_csv(world_wars, "docs/data/clean/world_wars.csv")
```
