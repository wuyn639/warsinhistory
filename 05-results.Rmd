...
ggplot(school_enrolment,aes(Year, y = SchoolEnrolment, colour = Entity, group = Entity)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=13)) +
  scale_color_discrete(breaks=c("France", "Japan", "Bulgaria", "Germany", "Belgium", "Greece",
...
ggplot(HDI_table,aes(Year, y = HDI, colour = Entity)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=13)) +  
  scale_color_discrete(breaks = c("Germany", "France", "Belgium", "Japan", "Italy", 
...
ggplot(HDI_table,aes(Year, y = HDI, colour = Entity)) +
  ...
  theme(plot.title = element_text(hjust = 0.5, size=13)) +
  scale_color_discrete(breaks = c("Germany", "Belgium", "France", "Japan", "Italy",
