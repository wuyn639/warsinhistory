...
![Caption for the picture.](data/pictures/picture1.png)
...
![Caption for the picture.](data/pictures/picture2.png)
...
III.	Intra-state wars
  a.	Civil Wars
    i.	For central control (war type 4)
    ii.	Over local issues (war type 5)
